...
$help = array(
	...
	array(
		0 => 'Co to jest BBCode?',
		1 => 'BBCode jest specjalną implementacją języka HTML, która daje lepszą kontrolę formatowania poszczególnych elementów w postach. Używanie BBCode na forum jest uzależnione od ustawień określanych przez administratora. Można wyłączyć BBCode w poszczególnych postach, zaznaczając odpowiednią funkcję w formularzu tworzenia posta. Sam BBCode jest podobny w składni do języka HTML, ale znaczniki zawarte są w nawiasach kwadratowych <code>[przykład]</code> zamiast w używanych w HTML-u nawiasach ostrych <code>&lt;przykład&gt;</code>. Każdy znacznik składa się ze znacznika otwierającego <code><strong>[</strong><em>nazwa_znacznika</em><strong>]</strong></code> i zamykającego <code><strong>[/</strong><em>nazwa_znacznika</em><strong>]</strong></code>, np. <code><strong>[b][/b]</strong></code>. Zależnie od używanego szablonu można w bardzo łatwy sposób dodawać znaczniki BBCode do postów, używając odpowiednich przycisków znajdujących się na górze formularza tworzenia posta.'
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'BBCode zawiera znaczniki umożliwiające szybką zmianę podstawowego wyglądu tekstu. Można to uzyskać w następujący sposób:<ul><li>Aby pogrubić jakiś tekst, należy wstawić go pomiędzy znaczniki <code><strong>[b][/b]</strong></code>. Przykład: <code><strong>[b]</strong>Tekst<strong>[/b]</strong></code> będzie wyświetlany jako <strong>Tekst</strong></li><li>Aby pochylić jakiś tekst, należy wstawić go pomiędzy znaczniki <code><strong>[i][/i]</strong></code>. Przykład: <code><strong>[i]</strong>Tekst<strong>[/i]</strong></code> będzie wyświetlany jako <em>Tekst</em></li><li>Aby podkreślić jakiś tekst, należy wstawić go pomiędzy znaczniki <code><strong>[u][/u]</strong></code>. Przykład: <code><strong>[u]</strong>Tekst<strong>[/u]</strong></code> będzie wyświetlany jako <u>Tekst</u>.</li></ul>'
	),
	array(
		0 => 'Jak zmienić kolor lub rozmiar tekstu?',
		1 => 'Aby zmienić kolor lub rozmiar tekstu można użyć znaczników wymienionych poniżej. Końcowy rezultat użycia znaczników formatujących zależy od używanej przeglądarki i systemu operacyjnego.<ul><li>Zmianę koloru tekstu można uzyskać poprzez zawarcie tekstu pomiędzy znacznikami <code><strong>[color=]</strong></code> i <code><strong>[/color]</strong></code>. Po znaku = należy podać nazwę koloru, np. red, blue, yellow, albo wartość szesnastkową, np. #FFFFFF, #000000. Przykładowo, aby uzyskać tekst w <span style="color:red">kolorze czerwonym</span>, należy użyć kodu <code><strong>[color=</strong>red<strong>]</strong>kolorze czerwonym<strong>[/color]</strong></code> albo <code><strong>[color=</strong>#FF0000<strong>]</strong>kolorze czerwonym<strong>[/color]</strong></code>.</li><li>Zmianę rozmiaru tekstu można uzyskać podobnie, jak i w przypadku koloru poprzez zawarcie tekstu pomiędzy znacznikami <code><strong>[size=]</strong></code> i <code><strong>[/size]</strong></code>. Ten znacznik jest uzależniony od używanego szablonu, niemniej zalecanym formatem jest wartość liczbowa wyrażona w procentach określająca rozmiar tekstu począwszy od wartości 20 – bardzo mały, aż do 200 – bardzo duży. Na przykład, aby uzyskać <span style="font-size:30%;">mały rozmiar tekstu</span>, należy użyć kodu <code><strong>[size=</strong>30<strong>]</strong>mały rozmiar tekstu<strong>[/size]</strong></code> a <span style="font-size:200%;">duży rozmiar tekstu</span>, należy użyć kodu <code><strong>[size=</strong>200<strong>]</strong>duży rozmiar tekstu<strong>[/size]</strong></code>.</li></ul>'
	),
	array(
		0 => 'Czy można łączyć znaczniki formatujące?',
		1 => 'Tak, naturalnie, że można. Na przykład, aby zwrócić czyjąś uwagę można napisać: <code><strong>[size=</strong>200<strong>][color=</strong>red<strong>][b]</strong>POPATRZ NA MNIE!<strong>[/b][/color][/size]</strong></code>. Tak napisany kod zostanie wyświetlony następująco: <span style="color:red;font-size:200%;"><strong>POPATRZ NA MNIE!</strong></span> Nie zaleca się nadużywania w tekście tego typu formatowania. Proszę pamiętać o prawidłowym domykaniu znaczników – zachowaniu poprawnej ich kolejności. Na przykład następujący kod jest nieprawidłowy: <code><strong>[b][u]</strong>Tekst<strong>[/b][/u]</strong></code>. Po słowie Tekst powinien zostać użyty znacznik zamykający <code><strong>[/u]</strong></code>. Prawidłowa konstrukcja tego kodu powinna wyglądać następująco: <code><strong>[b][u]</strong>Tekst<strong>[/u][/b]</strong></code>.'
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'BBCode używane w phpBB zawiera znacznik umożliwiający wstawianie obrazków do postów. Należy jednak pamiętać o dwóch istotnych kwestiach:<ul><li>wielu użytkowników nie lubi wielu obrazków w postach</li><li>wstawiany obrazek musi być dostępny w internecie – nie może istnieć tylko na komputerze lokalnym, chyba że jest on serwerem</li></ul>Aby wstawić obrazek, należy zawrzeć jego adres URL pomiędzy znacznikami <code><strong>[img]</strong></code> i <code><strong>[/img]</strong></code>. Na przykład:<br /><br /><code><strong>[img]</strong>http://www.phpbb.com/theme/images/logos/blue/160x52.png<strong>[/img]</strong></code><br /><br />Jeśli obrazek ma być odnośnikiem do jakiejś strony, należy jego adres URL umieścić pomiędzy znacznikami <code><strong>[url]</strong></code> i <code><strong>[/url]</strong></code> w następujący sposób:<br /><br /><strong>[url=http://www.phpbb.com/][img]</strong>http://www.phpbb.com/theme/images/logos/blue/160x52.png<strong>[/img][/url]</strong><br /><br /> Tak przygotowany odnośnik może wyglądać tak:<br /><br /><a href="http://www.phpbb.com/"><img src="http://www.phpbb.com/theme/images/logos/blue/160x52.png" alt="" /></a>'
	),
	array(

...
$lang = array_merge($lang, array(
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<p>Naciśnięcie przycisku znajdującego się poniżej spowoduje przeniesienie do panelu administracji (PA). Poświęć chwilę na sprawdzenie dostępnych funkcji. Pomoc możesz uzyskać na stronie internetowej phpBB3, zapoznając się z <a href="http://www.phpbb.com/support/documentation/3.0/">dokumentacją</a> oraz na forum <a href="http://www.phpbb.com/community/viewforum.php?f=46">pomocy</a>. Aby uzyskać więcej informacji przeczytaj artykuł: <a href="%3$s">Informacje podstawowe</a>.</p><p><strong>Przed użyciem witryny zmień nazwę, przenieś lub usuń katalog instalacyjny „install/”. W innym przypadku dostępny będzie tylko panel administracji (PA).</strong></p>',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTRUCTIONS'		=> '
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Przejdź do <a href="http://www.phpbb.com/downloads/" title="http://www.phpbb.com/downloads/">strony pobierania</a> i pobierz archiwum zawierające pakiet automatycznej aktualizacji.<br /><br /></li>

...
$lang = array_merge($lang, array(
	...
	'ACP_ORPHAN_ATTACHMENTS_EXPLAIN'	=> 'Tutaj można zobaczyć osierocone pliki. Takie pliki zazwyczaj powstają, gdy użytkownik załączy pliki do postu, ale go nie wyśle – załączony plik nie ma macierzystego postu. Można usunąć te pliki lub dołączyć do istniejących postów. Dołączenie do postu wymaga znajomości prawidłowego ID postu. Operacja ta spowoduje przeniesienie osieroconego załącznika do postu o wskazanym ID.',
	...
	'ATTACH_TO_POST'			=> 'Załącz plik do postu',
	...
	'UPLOADING_FILE_TO'		=> 'Wysyłanie pliku „%1$s” do postu numer %2$d…',

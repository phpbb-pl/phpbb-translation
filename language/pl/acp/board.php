...
$lang = array_merge($lang, array(
	...
	'OVERRIDE_STYLE'		=> 'Zastępuj styl użytkownika',
	'OVERRIDE_STYLE_EXPLAIN'	=> 'Zamienia styl wybrany przez użytkownika na domyślny styl.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_BIRTHDAYS_EXPLAIN'	=> 'Wybranie opcji <samp>Tak</samp> umożliwi podawanie przez użytkowników swojej daty urodzenia i ich wiek będzie wyświetlany w profilach. Wyświetlanie informacji o urodzinach użytkowników na stronie indeksu witryny jest kontrolowane przez oddzielne ustawienia.',
	...
	'ALLOW_PM_REPORT'		=> 'Zgłaszenie prywatnych wiadomości',
	...
	'ALLOW_SIG_LINKS_EXPLAIN'	=> 'Wybranie opcji <samp>Nie</samp> spowoduje, że znacznik <code>[URL]</code> i automatyczne/magiczne adresy URL będą wyłączone.',
...
$lang = array_merge($lang, array(
	...
	'FULL_FOLDER_ACTION'		=> 'Domyślne działanie, gdy folder jest zapełniony',
	...
	'PM_EDIT_TIME'			=> 'Limit czasu zmian',
...
$lang = array_merge($lang, array(
	...
	'BUMP_INTERVAL_EXPLAIN'		=> 'Jest to czas, jaki musi upłynąć od opublikowania ostatniego postu na forum w temacie, aby temat ten mógł zostać przesunięty na początek listy tematów. Ustawienie wartości 0 spowoduje całkowite wyłączenie tej funkcji.',
	...
	'DISPLAY_LAST_EDITED_EXPLAIN'	=> 'Wybranie tej funkcji spowoduje wyświetlanie w postach informacji o zmianach postu.',
	'EDIT_TIME'			=> 'Czas zmiany treści',
	'EDIT_TIME_EXPLAIN'		=> 'Limit czasu w przeciągu, którego można zmieniać zawartość nowego postu. Wartość zero (0) wyłącza tę funkcję.',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> 'Jeśli jest wybrana opcja Tak i jest określony limit postów dla nowo zarejestrowanych użytkowników, użytkownicy ci będą przydzielani do grupy <em>Nowo zarejestrowani użytkownicy</em> i grupa ta będzie jednocześnie ich grupą domyślną. Może być to bardzo przydatne, jeśli chcesz przydzielić grupie domyślną rangę lub awatar, które następnie użytkownik dziedziczy.',
...
//	'ACC_USER_ADMIN'		=> 'Użytkownik + Admin',
	...
	'USERNAME_CHARS_EXPLAIN'	=> 'Zabronione znaki w nazwie użytkownika i odstępach: spacja, -, +, _, [ and ].',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_FORUM_EXPLAIN'		=> 'Tutaj można włączyć/wyłączyć kanały dla nowych postów pojedynczego forum i jego subfor.',
...
$lang = array_merge($lang, array(
	...
	'VISUAL_CONFIRM_REG_EXPLAIN'	=> 'Jeśli funkcja ta zostanie włączona, nowi użytkownicy, aby się zarejestrować, będą musieli przejść wprowadzić kod potwierdzający wyświetlany na obrazku. Jest to forma zabezpieczenia forum przed masową rejestracją wykonywaną przez boty.',
...
$lang = array_merge($lang, array(
	...
	'MAX_LOGIN_ATTEMPTS_EXPLAIN'	=> 'Maksymalna dozwolona liczba prób logowania do konta, po przekroczeniu której zostanie wymuszone użycie kodu potwierdzającego. Wartość 0 zabezpiecza przed przełączaniem zabezpieczeń anty spambotowych do różnych kont użytkownika.',
	...
	'TPL_ALLOW_PHP_EXPLAIN'		=> 'Jeśli ta funcja jest włączona, składnia <code>PHP</code> i <code>INCLUDEPHP</code> będzie rozpoznawana i przetwarzana w szablonach.',
));
...
$lang = array_merge($lang, array(
	...
	'USE_SMTP_EXPLAIN'		=> 'Wybierz „Tak”, jeśli takie jest twoje życzenie lub trzeba wysyłać wiadomości e-mail przez dany serwer zamiast przez lokalną funkcję pocztową.',
));
